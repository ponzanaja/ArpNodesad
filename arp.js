...
//////////////////////////////////  NEW SECTION ///////////////////////////////
  ...
  deviceNetwork.getSubtree({
    ...
    if (err) {
      ...
      sumInbound += inbound[8].inbound
      sumOutbound += outbound[8].outbound
  ...
  if (check) {
    ...
    setTimeout(() => {   
      let inb =  inbound[8].inbound
      let outb = outbound[8].outbound 
      let mainlinkData = {
        in: inb,
        out: outb
      }
    ...
    setTimeout(() => {  
    let sumInterface = intSpd[8].intSpd/1048576
